...
CAPTION_MARGIN_V=48
CAPTION_OUTLINE=2
CAPTION_FIXED_TOP=SAFE_BOTTOM_Y+54
CAPTION_STYLE=f"Alignment=6,MarginV={CAPTION_FIXED_TOP},MarginL=72,MarginR=72,FontSize={CAPTION_FONT_SIZE},Outline={CAPTION_OUTLINE},Shadow=1,Bold=0,WrapStyle=0"
