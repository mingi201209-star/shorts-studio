...
CAPTION_MARGIN_V=48
CAPTION_OUTLINE=2
CAPTION_STYLE=f"Alignment=2,MarginV={CAPTION_MARGIN_V},MarginL=60,MarginR=60,FontSize={CAPTION_FONT_SIZE},Outline={CAPTION_OUTLINE},Shadow=1,Bold=0,WrapStyle=2"
